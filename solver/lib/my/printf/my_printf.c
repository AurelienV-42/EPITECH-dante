...
static int stock_to_value(char stock)
{
	int i = 0;
...
static function *init_tab(void)
{
	function *tab = malloc(sizeof(function) * 12);
...
static int loop(char *str, int *i, va_list list, function *tab)
{
	int c = 0;
	char stock;
	int nb;
